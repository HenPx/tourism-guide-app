    ...
    return(
        ...
        <div className="relative flex justify-center items-center">
            {currentIndex > 0 && (
                ...
                <button onClick={handlePrevReview} className="absolute -left-6  top-1/2 -translate-y-1/2 border border-[#3085A7] w-[60px] h-[60px] flex items-center justify-center rounded-full shadow-md cursor-pointer text-[#3085A7]">
                    <ArrowLeft/>
                </button>
            )}
            ...
            {currentIndex < review.length-1 && (
                <button onClick={handleNextReview} className="absolute -right-6 top-1/2 -translate-y-1/2 bg-[#3085A7] w-[60px] h-[60px] flex items-center justify-center rounded-full shadow-md cursor-pointe text-white">
                    <ArrowRight/>
                </button>
            )}
        </div>
